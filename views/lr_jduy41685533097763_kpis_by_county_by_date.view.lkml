# The name of this view in Looker is "Lr Jduy41685533097763 Kpis By County By Date"
view: lr_jduy41685533097763_kpis_by_county_by_date {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `looker_scratch.LR_JDUY41685533097763_kpis_by_county_by_date` ;;
