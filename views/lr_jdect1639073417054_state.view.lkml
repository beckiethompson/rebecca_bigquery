# The name of this view in Looker is "Lr Jdect1639073417054 State"
view: lr_jdect1639073417054_state {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `looker_scratch.LR_JDECT1639073417054_state` ;;
